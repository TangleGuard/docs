...
You can also see a visual preview of your architecture while configuring.
...
## Using templates <Badge text="workspace only" variant="note" />
...
You can edit the layer at any time.
Change the name of the layer just by changing the name of the input field.
It will get saved when the input is not focused anymore.
