...
This software is provided to you by **Archwise Solutions U.G. i.G.** ("Licensor") free of charge for the purpose of testing, evaluation, and feedback. You are granted a non-exclusive, non-transferable, revocable license to use the software on your local machine.
