...
When you open the visualization you'll first see the top level structure of your workspace.
Usually those are the packages in your workspace, but programming languages differ in how they organize their code.
You can see how the top level components are connected to each other.
The number in brackets is the line count of the package.
...
You can move nodes around by dragging them with your mouse.
